...
class AveTeamDetailViewController: UIViewController, MFMailComposeViewControllerDelegate  {
...
//        _ = sender as! UIBarButtonItem
        ...
        mailComposer.setToRecipients([propObj["agentEmail"] as! String])
        mailComposer.setSubject("[iPhone App Contact] for \(title!)")
        mailComposer.setMessageBody("Hello <strong>\(propObj["agentName"]!)</strong>,<br/> I am interested in some of your listings. <br>Regards", isHTML: true)
...
//        if segue.identifier == "showMyListings" {
//            let vc = segue.destination as? AveTeamDetailViewController
//                performSegue(withIdentifier: "showMyListings", sender: self)
//        } else if segue.identifier == "showTeresListings" {
//            let tvc = segue.destination as? NewDetailViewController {
//                performSegue(withIdentifier: "showTeresListings", sender: self)
//            }
//        }
//    }
