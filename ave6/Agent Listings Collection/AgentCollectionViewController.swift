//
//  AgentCollectionViewController.swift
//  ave6
//
...
class AgentCollectionViewController: UICollectionViewController, UITabBarDelegate {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        var listingClass = PFObject(className: "Bobbennion")
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let pdVC =  storyboard!.instantiateViewController(withIdentifier: "AgentListingDetail") as! AgentListingDetailViewController
    ...
    func queryAllListings() {
        ...
        let query = PFQuery(className: "Bobbennion")
